...
<body>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?= $this->urldecode(str)l('deconnexion'); ?>"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Calendrier	
    ...
    <script src="<?= $this->assetUrl('bower_components/raphael/raphael-min.js') ?>"></script>
    <script src="<?= $this->assetUrl('bower_components/morrisjs/morris.min.js') ?>"></script>
