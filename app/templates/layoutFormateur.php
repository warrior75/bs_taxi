        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?= $this->url('formateur');?>"><i class="fa fa-home"></i> Gestion BS TAXI</a>
                </div>
                <!-- /.navbar-header -->
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li>
                        <a class="dropdown-toggle" href="<?= $this->url('lessonForm');?>">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li><a href="<?= $this->url('passwordForm');?>"><i class="fa fa-lock fa-fw"></i>Changer Mot de passe</a>
                            </li>
                            <li class="divider"></li>
         ...
         <div class="panel-footer">
            ...
            <input id="btn-input" name="text_body" type="text" class="form-control input-sm" required placeholder="Votre message . . ."/>
